      ...
      >
        ...
        <li className="rounded-md border border-panel-border bg-panel p-3.5 shadow-sm md:col-span-2">
          <label className="flex items-start gap-2.5">
            ...
            <span className="flex flex-col gap-0.5">
              <span className="text-[0.95rem] font-semibold">
                Start tracker entry on focus start
              </span>
              <span className="text-[0.8rem] leading-snug text-muted">
                When you start a focus phase, create a new entry on your active
                sheet.
              </span>
            </span>
          </label>
        ...
        <li className="rounded-md border border-panel-border bg-panel p-3.5 shadow-sm md:col-span-2">
          <label className="flex flex-col gap-2">
            <span className="text-[0.95rem] font-semibold">
              Focus entry description (supports @tags)
            </span>
            ...
            />
            <span className="text-[0.8rem] leading-snug text-muted">
              Used when a focus phase creates a new tracker entry on the active
              sheet.
            </span>
          </label>
        </li>

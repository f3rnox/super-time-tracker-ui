...
const provider_options: {
  ...
  { value: 'none', label: 'Disabled', description: 'Do not call any AI provider.' },
  { value: 'openai', label: 'OpenAI', description: 'Use OpenAI for suggestions.' },
  { value: 'claude', label: 'Claude', description: 'Use Claude for suggestions.' },
  { value: 'google_ai', label: 'Google AI', description: 'Use Gemini for suggestions.' },
]
...
export function EntrySuggestionsSettingsView() {
  ...
  return (
    ...
    >
      <ul className="m-0 flex w-full list-none flex-col gap-2 p-0" aria-label="AI suggestion settings">
        ...
        <li className="rounded-md border border-panel-border bg-panel p-3.5 shadow-sm">
          <label className="flex flex-col gap-1.5">
            <span className="text-[0.95rem] font-semibold">Google AI API key</span>
            <input
              type="password"
              className={get_input_class_name()}

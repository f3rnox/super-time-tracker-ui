...
export const CLOUD_SYNC_ENABLED_STORAGE_KEY =
  "super-time-tracker-cloud-sync-enabled";
...
export const DAILY_FOCUS_TARGET_MINUTES_DEFAULT: DailyFocusTargetMinutes =
  "240";
...
export const WEEKLY_FOCUS_TARGET_MINUTES_DEFAULT: WeeklyFocusTargetMinutes =
  "1200";
...
export const WORK_HOURS_START_STORAGE_KEY =
  "super-time-tracker-work-hours-start";
...
export const FOCUS_GOAL_SCOPE_STORAGE_KEY =
  "super-time-tracker-focus-goal-scope";
...
export const FOCUS_GOAL_TAG_NAME_STORAGE_KEY =
  "super-time-tracker-focus-goal-tag-name";
...
export type EntrySuggestionProvider =
  | "none"
  | "openai"
  | "claude"
  | "google_ai";
...
export const ENTRY_SUGGESTION_PROVIDER_DEFAULT: EntrySuggestionProvider =
  "none";
...
export const GOOGLE_AI_API_KEY_STORAGE_KEY =
  "super-time-tracker-google-ai-api-key";

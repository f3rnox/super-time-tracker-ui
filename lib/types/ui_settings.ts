...
export const SHEET_TAG_FILTERS_STORAGE_KEY =
  "super-time-tracker-sheet-tag-filters";
...
export const DEFAULT_SHEET_SESSION_MODE_COOKIE_NAME =
  "stt-default-sheet-session-mode";

export const DEFAULT_SHEET_FIXED_NAME_STORAGE_KEY =
  "super-time-tracker-default-sheet-fixed-name";
export const DEFAULT_SHEET_FIXED_NAME_COOKIE_NAME =
  "stt-default-sheet-fixed-name";

...
const is_valid_today_focus_scope = (value: string): value is TodayFocusScope =>
  scope_values.includes(value as TodayFocusScope);

/**
 * Today view scope preference: all sheets or pinned sheets only.
 */
export const today_scope_preference =
  create_ui_preference_store<TodayFocusScope>({
